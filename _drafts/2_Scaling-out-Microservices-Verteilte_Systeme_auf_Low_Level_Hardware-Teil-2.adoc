...
[source, bash]
----
docker run -d -p 8083:8083 -p 8086:8086 -p 25826:25826/udp dilgerm/rpi-influxdb:1.0.0-rc2
----
...
docker run -d -i -p 3000:3000 --name grafana -v grafana-data:/var/lib/grafana fg2it/grafana-armhf:v3.1.1
----
