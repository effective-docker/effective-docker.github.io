...
getreten ist und starten Sie folgendes Skript in einer Konsole und lassen Sie es einfach für ein paar Minuten laufen.

[source, bash]
----
while true; do i=0; done <1>
----
<1> Das Beispiel ist aus dem Getting Started - Guide für Kapacitor unter https://docs.influxdata.com/kapacitor/v0.13/introduction/getting_started.

Spätestens nach 5 Minuten sollten Sie für genau diesen Knoten einen E-Mail Alarm erhalten.
