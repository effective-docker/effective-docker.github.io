---
layout: default
title: Microservices auf Commodity Hardware Teil 1 - Provisionierung mit Ansible
...
In der Zwischenzeit empfehle ich Ihnen, das jeweils aktuellste http://blog.hypriot.com/downloads/[Hypriot-Image] herunterzuladen.
